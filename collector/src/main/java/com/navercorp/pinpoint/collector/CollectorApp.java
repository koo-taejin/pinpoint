...
import com.navercorp.pinpoint.connectionmap.collector.ConnectionMapCollectorApp;
...
public class CollectorApp {
    ...
    public static void main(String[] args) {
        try {
            CollectorStarter starter = new CollectorStarter(CollectorApp.class, ConnectionMapCollectorApp.class);
            starter.start(args);
