...
import com.navercorp.pinpoint.connectionmap.web.dao.hbase.mapper.HbasePidStatDataResultsExtractor;
 ...
 */
@Repository
public class HbasePidStatDataDao implements PidStatDataDao {
    ...
    private final ResultsExtractor<List<PidSetVo>> hbaseAddressStatDataResultsExtractor = new HbasePidStatDataResultsExtractor();

    private final ConnectionMapTableDescriptor<ConnectionMapHbaseColumnFamily.PidStatData> descriptor;

    public HbasePidStatDataDao(HbaseOperations2 hbaseOperations2, ConnectionMapTableDescriptor<ConnectionMapHbaseColumnFamily.PidStatData> descriptor) {
        this.hbaseOperations2 = Objects.requireNonNull(hbaseOperations2, "hbaseOperations2");
        this.descriptor = Objects.requireNonNull(descriptor, "descriptor");
    }

    @Override
    public List<PidSetVo> getPids(String agentId, ValueRange range) {
        ...
        List<PidSetVo> pidHbaseVoList = this.hbaseOperations2.find(agentEventTableName, scan, hbaseAddressStatDataResultsExtractor);
        logger.debug("pidHbaseVoList found. {}", pidHbaseVoList);
