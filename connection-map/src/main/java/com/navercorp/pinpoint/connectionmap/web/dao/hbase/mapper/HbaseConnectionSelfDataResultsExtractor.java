 ...
 */
@Component
public class HbaseConnectionSelfDataResultsExtractor implements ResultsExtractor<List<ConnectionStatVo>> {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    private final HbaseConnectionSelfDataMapper connectionSelfDataMapper = new HbaseConnectionSelfDataMapper();
    ...
    public List<ConnectionStatVo> extractData(ResultScanner results) throws Exception {
        ...
        for (Result result : results) {
            try {
                index++;
                ConnectionStatVo connectionStatVo = connectionSelfDataMapper.mapRow(result, index);
