 ...
 * @author Taejin Koo
 */
public interface ServletRequestMappingExtractor extends UriExtractor<HttpServletRequest> {

    UriExtractorType TYPE = UriExtractorType.SERVLET_REQUEST_ATTRIBUTE;
